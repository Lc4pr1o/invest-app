// Vercel Serverless Function: proxy para cotação (Bolsai /stocks/{ticker}/quote).
...
export default async function handler(req, res) {
    ...
    try {
        const upstream = await fetch(`https://api.usebolsai.com/api/v1/stocks/${encodeURIComponent(ticker)}/quote`, {
